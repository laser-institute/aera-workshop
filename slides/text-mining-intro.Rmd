...
- A gentle introduction to text mining, including key concepts and definition
--

- Common Technique used in text mining (e.g. dictionary-based methods, topic modeling, etc.)
--

- Key uses and educational issues or problems that TM been used to address
--

- Common data sources use in TM
--

- Technical, ethical and legal considerations researchers need to be aware of who are working with network data, particularly in STEM Ed contexts
--

- What does TM research look like in practice?
