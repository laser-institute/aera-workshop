...
<h3>Idea #1: Though we often focus on individuals (or the depedencies between individuals), social network analysis allows us to focus on relationships between individuals</h3>
...
- The data we use as input, too, can take different forms:
  - Self-reported relationships (e.g., [Horn et al., 2020](https://journals.sagepub.com/doi/full/10.1177/2332858420914898))
  - Relationships inferred from digital sources of data (e.g., [Coburn et al., 2012](https://www.journals.uchicago.edu/doi/full/10.1086/667699) and [Hu et al., 2018](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C43&q=pinterest+torphy&btnG=) and [Staudt Willet & Carpenter, 2020](https://www.tandfonline.com/doi/full/10.1080/15391523.2020.1722978))

--

<h3>Idea #2: The kinds of relationships we study depend on our research questions&mdash;and, prior research and theory can guide us</h3>
...
<h3>Idea #3: Social network analysis refers to a collection of methods for visualizing, describing, and modeling social network data</h3>
...
How might ethical challenges intersect with your social network analyses?

---

# Summary

- Idea #1: Though we often focus on individuals (or the depedencies between individuals), social network analysis allows us to focus on relationships between individuals
- Idea #2: The kinds of relationships we study depend on our research questions&mdash;and, prior research and theory can guide us
- Idea #3: Social network analysis refers to a collection of methods for visualizing, describing, and modeling social network data
- Idea #4: Relationships can be measured using self-reported and&mdash;increasingly&mdash;digital data sources
- Idea #5: An edgelist is a key data structure that can position us to visualize, describe, and model social network data
...
- [Data Science in Education Using R](https://datascienceineducation.com/)
  - [C12: SNA and social media data](https://datascienceineducation.com/c12.html)
